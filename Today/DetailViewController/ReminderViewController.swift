...
//  Today
//
//  Created by Роман Замолотов on 16.01.2023.
//
...
class ReminderViewController: UICollectionViewController {
    ...
    private func prepareForViewing() {
        ...
        if workigReminder != reminder {
            reminder = workigReminder
        }
        updateSnapshotForViewing()
    }
